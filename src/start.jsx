...
export default function ComplexMultiVariant() {
  ...
  const [metaClickCounts, setMetaClickCounts] = useState({});
  ...
  return (
    ...
    >
        ...
        {candidates.map((candidate) => (
          <button
            ...
            style={{
              ...
              padding: "10px 16px",
              backgroundColor:
                selected.id === candidate.id ? "#4caf50" : "#ddd",
      ...
      >
          ...
          <div class="header-container">
            ...
            <nav class="navigation">
              <a
                ...
                style={{ fontWeight: selected.fontWeight.button }}
              >
                Start
              </a>
              <a
            ...
            <div class="right-section">
              ...
              <div class="title-section">
                <h1
                  class="main-title"
                  style={{ fontWeight: selected.fontWeight.header }}
                >
                  Umfrage Platform
                </h1>
                <p
                  class="subtitle-main"
                  style={{ fontWeight: selected.fontWeight.subtitle }}
                >
        ...
        >
          ...
          <div style={{ textAlign: "left", flex: 1, marginRight: 20 }}>
            <p style={{ fontWeight: "bold", marginBottom: 8, color: "black" }}>
              Klicken Sie bitte an, was Ihnen besonders gefällt. (Multiple
              Choice)
            </p>
            <div
              style={{
        ...
        <section class="main">
          <h1 style={{ fontWeight: selected.fontWeight.title }}>
            Willkommen zur Umfrage
          </h1>
          <p style={{ fontWeight: selected.fontWeight.usw }}>
            Beantworten Sie gezielt strukturierte Fragenkataloge und helfen Sie
            dabei, strategische Themen in Ihrem Unternehmen zu analysieren.
          </p>
        </section>
        ...
        <section class="stats">
          <div class="stat">
            ...
            <div>Verfügbare Kataloge</div>
          </div>
          <div class="stat">
            <div class="number">107</div>
            <div>Geplante Projekte</div>
          </div>
          <div class="stat">
            <div class="number">15</div>
            <div>Spontanbewertungen</div>
          </div>
        </section>
        ...
        <section class="catalogs">
          <div
            class="survey-card"
            style={{ fontWeight: selected.fontWeight.title }}
          >
            <div
              class="card-top blue"
              style={{
                background: selected.colors[0],
                color: selected.fontColor.color,
              }}
            >
              <div class="top-row">
                <span
                  class="tag"
                  style={{ fontWeight: selected.fontWeight.usw }}
                >
                  IT-Strategie
                </span>
                <span
              ...
              <p
                ...
                style={{ fontWeight: selected.fontWeight.subtitle }}
              >
                Bewertung der grundlegenden IT-Strategien und deren Umsetzung in
                Ihrem Unternehmen.
              </p>
            </div>
              ...
              <div class="features">
                ...
                <ul
                  style={{
                    listStyleType: "none",
                    paddingLeft: 0,
                    fontWeight: selected.fontWeight.usw,
                  }}
                >
          ...
          >
            ...
            >
              ...
              <p class="subtitle1">
                Erhebung des Reifegrads Ihrer Informationssicherheit anhand
                konkreter Maßnahmen.
              </p>
            </div>
            <div class="card-bottom">
          ...
          >
            <div
              class="card-top green"
              style={{
                background: selected.colors[2],
                color: selected.fontColor.color,
              }}
            >
              <div class="top-row">
              ...
              <p
                ...
                style={{ fontWeight: selected.fontWeight.subtitle }}
              >
                Bewertung des Digitalisierungsgrads Ihres Unternehmens im
                Branchenvergleich.
              </p>
            </div>
            <div class="card-bottom">
          ...
          >
            <div
              class="card-top purple"
              style={{
                background: selected.colors[3],
                color: selected.fontColor.color,
              }}
            >
              <div class="top-row">
              ...
              <p class="subtitle1">
                Analyse der Datenmanagementstruktur und des
                Datenstrategie-Reifegrads Ihres Unternehmens.
              </p>
            </div>
            <div class="card-bottom">
              <div class="info-row">
        ...
        <footer
          style={{
            fontWeight: selected.fontWeight.subtitle,
            backgroundColor: "#f9fafb",
            color: "#fff",
            padding: "20px",
            marginTop: 40,
