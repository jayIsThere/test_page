...
`}</style>
      ...
      >
        ...
        <div style={{ marginTop: 10 }}>
          <p style={{ fontWeight: "bold", color: "white", marginBottom: 8 }}>
            Ihre Meinung
          </p>
          <textarea
            value={inputText}
      ...
      <div className="app-container">
        ...
        >
          ...
          <div class="nav-section">
            ...
            >
              {selected.emoji.uebersicht}Übersicht
            </a>
            <div class="nav-sub">
              <a
                class="nav-link"
              ...
              >
                {selected.emoji.final}Finalkatalog erstellen
              </a>
            </div>
            ...
            <div class="nav-item">
              <a
                ...
                style={{ fontWeight: selected.fontWeight.title }}
              >
                {selected.emoji.itstrategie} IT Strategie
              </a>
              <p
                class="nav-subtext"
                style={{ fontWeight: selected.fontWeight.subtitle }}
              >
                Strategische IT-Planung und -Ausrichtung
              </p>
            </div>
            <div class="nav-item">
              <a
                ...
                style={{ fontWeight: selected.fontWeight.title }}
              >
                {selected.emoji.projektmanagement}IT Projektmanagement
              </a>
              <p
                class="nav-subtext"
                style={{ fontWeight: selected.fontWeight.subtitle }}
          ...
          <div class="nav-item">
            <a
              ...
              style={{ fontWeight: selected.fontWeight.title }}
            >
              {selected.emoji.sourcing} Sourcing
            </a>
            <p
              class="nav-subtext"
              style={{ fontWeight: selected.fontWeight.subtitle }}
          ...
          <div class="nav-item">
            <a
              ...
              style={{ fontWeight: selected.fontWeight.title }}
            >
              {selected.emoji.betriebsmodell} Betriebsmodell
            </a>
            <p
              class="nav-subtext"
              style={{ fontWeight: selected.fontWeight.subtitle }}
        ...
        <div class="main">
          <div class="header">
            <h1 style={{ fontWeight: selected.fontWeight.title }}>
              Fragenkatalog Administrator
            </h1>
            <p style={{ fontWeight: selected.fontWeight.subtitle }}>
          ...
          >
            <h2 style={{ fontWeight: selected.fontWeight.header }}>
              Themenschwerpunkte
            </h2>
            <button
              class="create-button"
            ...
            >
              {selected.emoji.final}finale Katalog erstellen
            </button>
          </div>
          ...
          <div class="topics">
            <div class="topic-card blue" style={{ background: "white" }}>
              <div
                class="card-top-bar blue"
                style={{ background: selected.colors[0] }}
              ></div>
              <h3 style={{ fontWeight: selected.fontWeight.title }}>
                IT Strategie
              </h3>
              <ul>
                <li style={{ fontWeight: selected.fontWeight.subtitle }}>
                  Strategische IT-Planung und -Ausrichtung
                </li>
              </ul>
            ...
            <div class="topic-card dark" style={{ background: "white" }}>
              <div
                class="card-top-bar dark"
                style={{ background: selected.colors[1] }}
              ></div>
              <h3 style={{ fontWeight: selected.fontWeight.title }}>
            ...
            <div class="topic-card green" style={{ background: "white" }}>
              <div
                class="card-top-bar green"
                style={{ background: selected.colors[2] }}
              ></div>
              <h3 style={{ fontWeight: selected.fontWeight.title }}>
                Sourcing
              </h3>
            ...
            <div class="topic-card orange" style={{ background: "white" }}>
              <div
                class="card-top-bar  orange"
                style={{ background: selected.colors[3] }}
              ></div>
              <h3 style={{ fontWeight: selected.fontWeight.title }}>
                Betriebsmodell
              </h3>
          ...
          <div class="actions" style={{ backgroundColor: "#264555" }}>
            <button style={{ fontWeight: selected.fontWeight.usw }}>
              Alle exportieren
            </button>
            <button style={{ fontWeight: selected.fontWeight.usw }}>
              Import/Export
